...
public class Gui extends PApplet {
	...
	private PFont f08, f20;
	public float length = 50.0f;
	public float rotation = 0.0f;
	public Tuple<Float, Float> offset= new Tuple<Float, Float>(74.0f, 84.0f);
	public Tuple<Integer, Integer> numberOfArms= new Tuple<Integer, Integer>(6, 12);
	public Tuple<Integer, Integer> thickness= new Tuple<Integer, Integer>(2, 12);
	public Tuple<Integer, Integer> colors= new Tuple<Integer, Integer>(color(255, 255, 255, 255), color(0, 0, 0, 255));
	private ControlP5 cp5;
	private float guiTimeout = 0;
	...
	public void setup() {
		// System.out.println("Debug:\tGui setup");
//		noLoop();
